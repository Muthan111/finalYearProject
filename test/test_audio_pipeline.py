...
async def test_audio_pipeline():
    """
    Test the audio processing pipeline by simulating an audio file upload and processing.
    """
    # Create an instance of the AudioPipeline
    audio_pipeline = AudioCleanService()

    # Simulate an audio file upload (replace 'test_audio.wav' with your test file)
