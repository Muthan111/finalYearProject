from src.stutter_detector.component_services.Upload_service import (
    UploadService,
)
from src.stutter_detector.component_services.microphone_service import (
    MicrophoneService,
)
...
class AudioPipeline:
    ...
    async def run_pipeline(self, file):
        ...
        Cleans the audio file.
        Returns the paths and URLs of the original and cleaned audio files.
        """
        ...
        try:
            ...
            cleaned_audio = await self.audio_clean_service.preprocess_audio(
                audio_path
            )
