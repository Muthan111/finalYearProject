...
class DetectorService:
    ...
    async def detect_stutter(self):
        mockMicrophone = self.MockComponents.MockMicrophone()
        ...
        return {
            ...
            "mockAudioAnalysis": mockAudioAnalysis,
            "mockRepetitionDetection": mockRepetitionDetection,
            "mockProlongationDetection": mockProlongationDetection,
            "mockStutterDetection": mockStutterDetection,
            "mockStutterAnalysis": mockStutterAnalysis,
            "mockStutterReport": mockStutterReport,
