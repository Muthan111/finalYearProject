...
class FeedbackService:
    ...
    def personalized_feedback(self, detection_feedback):
        ...
        try:
            ...
            The voice recording has been analyzed
            and the following feedback has been generated:
            {detection_feedback}
            Ignore any blocks with the type rms_silence_block
            Generate a personalized feedback
            message based on the provided feedback.
            The feedback should be concise,
            encouraging, and provide actionable advice for improvement.
            """
